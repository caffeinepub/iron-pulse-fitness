...
export class Backend implements backendInterface {
    ...
    async getAllNewsletterSignups(): Promise<Array<[string, Time]>> {
        if (this.processError) {
            try {
    ...
    async getNewsletterSignupTimestamp(arg0: string): Promise<Time | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getNewsletterSignupTimestamp(arg0);
    ...
    async signupNewsletter(arg0: string): Promise<string> {
        if (this.processError) {
            try {
